;(function ($) {
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            $(this.element).append('<div class="yf-clicker"><div class="yf-progress"></div></div>')

            $(this.element).append(this.options.multipleFiles ? this.options.multipleUpload : this.options.singleUpload);
            $(this.element).find('.yf-clicker').click(function () {
                $(self.element).find('input[type=file]').trigger('click')
            });
        ...
        sendFile: function (fileAdded) {
            ...
            xhr.upload.addEventListener('progress', function (evt) {
                if (evt.lengthComputable) {
                    ...
                    fileAdded.$element.find('.yf-progress').html(Math.round(progress * 100) + '%');
                }
            });
        ...
        uploadComplete: function (serverResponse, fileAdded) {
            ...
            fileAdded.$element.find('.yf-progress').hide();
